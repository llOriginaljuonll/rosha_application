...
class Competition(models.Model):
    ...
    deadline_time = models.TextField(null=True, blank=True, editable=False)
    ann_date = models.DateField(null=True, blank=True)
    ann_time = models.TextField(null=True, blank=True, editable=False)
    compt_date = models.DateField(null=True, blank=True)
    compt_time = models.TimeField(null=True, blank=True, editable=False)
